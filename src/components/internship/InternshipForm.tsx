...
export const InternshipForm = () => {
  ...
  return (
    <div className="bg-zinc-900/90 border border-zinc-800 p-4 sm:p-6 md:p-8 rounded-xl shadow-xl mb-8 md:mb-12 w-full max-w-4xl mx-auto my-8 sm:my-12">
      {/* Progress bar */}
      <div className="mb-6 md:mb-10 px-2 sm:px-4">
        ...
        <div className="relative mb-6 md:mb-8">
            ...
            {STEPS.map((s) => {
              ...
              return (
                ...
                >
                  <div 
                    className={`
                      relative z-10 flex items-center justify-center w-6 h-6 sm:w-8 sm:h-8 rounded-full text-xs sm:text-sm font-medium transition-all duration-300
                  ...
                  <span 
                    className={`
                      mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium transition-colors duration-300
          ...
          {/* Connecting line */}
          <div className="absolute top-3 sm:top-4 left-0 right-0 h-0.5 -translate-y-1/2 bg-zinc-800">
            <div 
